defmodule ParliamentSearchAgentWeb.DashboardLive do
  use ParliamentSearchAgentWeb, :live_view
  ...
  @workers [
    ParliamentSearchAgent.Workers.ReportsScraper,
    ParliamentSearchAgent.Workers.HearingTranscriptsScraper,
    ParliamentSearchAgent.Workers.BroadcastsScraper
  ]

  @impl true
  def mount(_params, _session, socket) do
    if connected?(socket) do
      Phoenix.PubSub.subscribe(ParliamentSearchAgent.PubSub, "items:new")
      Phoenix.PubSub.subscribe(ParliamentSearchAgent.PubSub, "items:updated")
      schedule_refresh()
    end
