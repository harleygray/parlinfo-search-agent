defmodule ParlInfoSearchAgent.Release do
  ...
  def backfill_reports do
    ...
    Ecto.Migrator.with_repo(ParlInfoSearchAgent.Repo, fn repo ->
      changeset =
        ParlInfoSearchAgent.Workers.BackfillReportsWorker.new(%{page: 0, total: 0})
  ...
  def backfill_transcripts do
    ...
    Ecto.Migrator.with_repo(ParlInfoSearchAgent.Repo, fn repo ->
      changeset =
        ParlInfoSearchAgent.Workers.BackfillTranscriptsWorker.new(%{page: 0, total: 0})
