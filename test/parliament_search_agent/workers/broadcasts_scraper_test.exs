defmodule ParliamentSearchAgent.Workers.BroadcastsScraperTest do
  use ParliamentSearchAgent.DataCase, async: false
  use Oban.Testing, repo: ParliamentSearchAgent.Repo

  import Mox

  alias ParliamentSearchAgent.Workers.BroadcastsScraper
  alias ParliamentSearchAgent.Items
  alias ParliamentSearchAgent.Items.Broadcast
  alias ParliamentSearchAgent.Scraper.MockParlViewClient
