defmodule ParliamentSearchAgent.Workers.HearingTranscriptsScraperTest do
  use ParliamentSearchAgent.DataCase, async: false
  use Oban.Testing, repo: ParliamentSearchAgent.Repo

  import Mox

  alias ParliamentSearchAgent.Workers.HearingTranscriptsScraper
  alias ParliamentSearchAgent.Items
  alias ParliamentSearchAgent.Items.HearingTranscript
  alias ParliamentSearchAgent.Scraper.MockParlinfoClient
